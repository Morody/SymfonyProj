 ...
 */
final class Version20221205085722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE description_video ADD video_id INT DEFAULT NULL, DROP likes');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE description_video ADD likes INT NOT NULL, DROP video_id');
    }
}
